<form class="flex items-center mt-14 md:px-60">   
    ...
    <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-[#AACB73] rounded-lg border border-[#ccf38e] hover:bg-[#85a05a] focus:ring-4 focus:outline-none focus:ring-[#c4eb86] dark:bg-[#AACB73] dark:hover:bg-[#85a05a] dark:focus:ring-[#c4eb86]">
